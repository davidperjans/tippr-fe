...
>(({ className, ...props }, ref) => (
    <tfoot
        ref={ref}
        className={cn(
            "border-t bg-bg-subtle/50 font-medium [&>tr]:last:border-b-0",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <tr
        ref={ref}
        className={cn(
            "border-b border-border-subtle transition-colors hover:bg-bg-subtle/50 data-[state=selected]:bg-bg-subtle",
            className
        )}
        {...props}
    />
