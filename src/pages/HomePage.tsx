        ...
        <section className="relative pt-20 pb-32 lg:pt-32 lg:pb-48 overflow-hidden">
          ...
          <div className="fixed inset-0 -z-30">
            <img
              ...
              className="w-full h-full object-cover opacity-200 grayscale brightness-50"
            />
      ...
      <footer className="py-12 bg-card border-t">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-6 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            <img src="/logo.svg" alt="Tippr" className="w-6 h-6 rounded" />
          ...
          <div className="flex items-center justify-center gap-6 text-sm text-muted-foreground">
            <a href="/terms" className="hover:text-primary transition-colors">Villkor</a>
            <a href="/privacy" className="hover:text-primary transition-colors">Integritet</a>
            <a href="/about" className="hover:text-primary transition-colors">Om oss</a>
            <a href="/contact" className="hover:text-primary transition-colors">Kontakta oss</a>
          </div>
        </div>
      </footer>
    </div>
